  ...
  const navItems = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          label: 'Brand',
          icon: createIcon('brand'),
          path: '/products/brands'
        },
        {
          label: 'Product Reviews',
          icon: createIcon('reviews'),
    ...
    },
    {
      ...
      icon: createIcon('vendors'),
      path: '/vendors'
    },
    {
      label: 'Reports',
      icon: createIcon('reports'),
      children: [
    ...
    {
      label: 'Support',
      icon: createIcon('support'),
      path: '/support'
    },
    {
      label: 'Homepage Setup',
      icon: createIcon('homepage'),
      path: '/homepage-setup'
    },
    {
      label: 'Staffs/Admin Manager',
      icon: createIcon('staff'),
      path: '/staff'
    },
    {
      label: 'Delivery',
